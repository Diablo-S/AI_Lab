...
// Tic Tac Toe Alpha Beta Pruning Algorithm
...
int minimax(char board[3][3], int depth, bool isAI, int alpha, int beta)
{
    int score = 0;
    int bestScore = 0;
            ...
            else
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    for (int j = 0; j < 3; j++)
                    {
                        ...
                        {
                            board[i][j] = 'X';
                            score = minimax(board, depth + 1, true, -beta, -alpha);
                            board[i][j] = ' ';
...
int bestMove(char board[3][3], int moveIndex)
{
    ...
    for (int i = 0; i < 3; i++)
    {
        for (int j = 0; j < 3; j++)
        {
            ...
            {
                board[i][j] = 'O';
                score = minimax(board, moveIndex + 1, false, -9999, 9999);
                board[i][j] = ' ';
                if (score > bestScore)
                {
                    bestScore = score;
